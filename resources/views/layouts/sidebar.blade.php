                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}" wire:navigate
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('dashboard') ? 'active bg-gray-100' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('tickets') }}" wire:navigate
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 dark:bg-gray-700 {{ request()->routeIs('tickets') ? 'active bg-gray-100' : '' }}">
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
